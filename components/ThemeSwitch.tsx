  ...
  return (
    <div className="flex items-center">
      <Menu as="div" className="relative inline-block text-left">
        <div className="hover:text-primary-500 dark:hover:text-primary-400 text-gray-700/85 transition-colors duration-200 dark:text-gray-300/80">
          <MenuButton
            aria-label="Theme switcher"
            className="focus-visible:outline-primary-500 rounded-md p-1 focus-visible:outline-2"
          >
